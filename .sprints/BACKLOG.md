...
| Sprint-01 | 11:15–12:00 | Repo creado, **README esqueleto en inglés**, guion v1 del video | D | Entrega | En progreso | README ya en inglés y con enlaces verificados; **falta que el humano ejecute `gh repo create` (guía M3)** — no es una acción que el agente ejecute sin confirmación |
...
| Sprint-02 | 12:30–13:30 | Caso de demo cerrado (correo ficticio) + `verify_entity` con Exa integrado | C | A, C | Done (auditado, pasada 2) | El agente detecta un dato que requiere verificación externa y la resuelve vía Exa |
